...
def displayStatisticsForPlayoffScheduledGames(dataStruct: List, parentFrame):
    """
...
# Testing Purposes
    ...
    game1 = Play(1, 1, 2, 'Manchester City',
                 'Manchester United', 5, 7, 0, 4, 0, 2, True)
    game2 = Play(1, 1, 2, 'Rangers',
                 'Celtic', 5, 7, 0, 4, 0, 2, True)
    game3 = Play(1, 1, 2, 'Real Madrid',
                 'Barcelona', 5, 7, 0, 4, 0, 2, True)
    game4 = Play(1, 1, 2, 'Bayern Munich',
                 'Borussia Dortmund', 5, 7, 0, 4, 0, 2, True)
    game5 = Play(1, 1, 2, 'Manchester City',
                 'Manchester United', 5, 7, 0, 4, 0, 2, True)
    game6 = Play(1, 1, 2, 'Manchester City',
                 'Manchester United', 5, 7, 0, 4, 0, 2, True)
    game7 = Play(1, 1, 2, 'Manchester City',
                 'Manchester United', 5, 7, 0, 4, 0, 2, True)
    game8 = Play(1, 1, 2, 'Manchester City',
                 'Manchester United', 5, 7, 0, 4, 0, 2, True)
    ...
    data5 = SchedulesWithPlay(
        1, 5, game5, date, 'Afternoon', True, False, 'Knockout')
    data6 = SchedulesWithPlay(
        1, 6, game6, date, 'Afternoon', True, False, 'Knockout')
    data7 = SchedulesWithPlay(
        1, 7, game7, date, 'Afternoon', True, False, 'QuaterFinal')
    data8 = SchedulesWithPlay(
        1, 8, game8, date, 'Afternoon', True, False, 'QuaterFinal')
    ...
    displayStatisticsForPlayoffScheduledGames(
